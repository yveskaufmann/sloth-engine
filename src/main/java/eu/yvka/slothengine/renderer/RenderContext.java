...
public class RenderContext {
	 ...
	 */
	public RenderState.FaceWinding frontFaceWinding;
	 ...
	 */
	public RenderState.TestFunc stencilTestFunc = RenderState.TestFunc.Always;
	...
	public void reset() {
		frontFaceWinding = RenderState.FaceWinding.GL_CCW;
		blend = false;
		clipDistance = false;
		colorLogicOp = false;
		colorLogicOp = false;
		...
		wireframe = false;
		depthTestMode = RenderState.TestFunc.Off;
		blendMode = RenderState.BlendFunc.Off;
		logicOperation = RenderState.LogicalPixelOperation.Copy;
		cullFaceMode = RenderState.CullFaceMode.Off;
		lineWith = 1.0f;
