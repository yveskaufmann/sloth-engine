...
import static core.renderer.RenderState.*;
...
public class RenderContext {
	...
	/**
	 * If enabled, clip core.geometry against user-defined half space i.
	 */
	...
	/**
	 * If enabled, the active fragment core.shader is run once for each covered sample,
	...
	/**
	 * If enabled and a vertex or core.geometry core.shader is active,
	 * then the derived point size is taken from the (potentially clipped)
	 * core.shader builtin gl_PointSize and clamped to the implementation-dependent point size range.
	 */
	...
	/**
	 * The current bounded core.shader
	 */
	...
	/**
	 * Current active core.texture unit
	 */
	public int activeTextureUnit;

	/**
	 * The current bounded textures.
	 * The index specifies to which core.texture unit the
	 * core.texture is bounded.
	 *
	 * The count of 80 core.texture unit comes from the specification
	 * <a href="https://www.opengl.org/sdk/docs/man/docbook4/xhtml/glActiveTexture.xml">glActiveTexture</a>
	 * which says that a  opengl driver must at least support 80 core.texture units.
	 */
