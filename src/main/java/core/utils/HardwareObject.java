...
public abstract class HardwareObject {
	...
	/**
	 * Marks that the hardware object must be updated by the core.renderer
	 ...
	 * and the core.renderer is responsible to set the id of the hardware object.
	 *
	 ...
	 * the core.renderer is responsible to set id of this object.
	 *
	 * @param id
	 */
	...
	/**
	 * @return true if the object must be updated before it could be used by the core.renderer.
	 */
	 ...
	 * using the corresponding core.renderer implementation.
	 *
	 * This is required in order to remove unused objects and
	 * clean up stuff.
	 *
	 * @param renderer the corresponding core.renderer implementation
	 */
